...
namespace ChocoDark.GlobalAudio
{
    ...
    public class GlobalAudio : MonoBehaviour
    {
        ...
        public static readonly UnityEvent<Channel> onChannelStop = new();
        ...
        public static void StopChannel(Channel channel) => onChannelStop.Invoke(channel);
        public static void PauseChannel(Channel channel, bool pause) => onChannelPause.Invoke(channel, pause);
